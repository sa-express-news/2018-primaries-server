...
primaryIDMap.set("Governor", 0);
primaryIDMap.set("U.S. Senate", 1);
primaryIDMap.set("U.S. House - District 21", 2);
primaryIDMap.set("U.S. House - District 23", 3);
primaryIDMap.set("Land Commissioner", 4);
primaryIDMap.set("U.S. House - District 35", 5);
primaryIDMap.set("Lieutenant Governor", 6);
primaryIDMap.set("Agriculture Commissioner", 7);
primaryIDMap.set("Railroad Commissioner", 8);
primaryIDMap.set("Bexar County District Attorney", 9);
...
primaryIDMap.set("State Representative - District 116", 17);
